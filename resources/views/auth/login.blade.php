        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form action="{{ route('auth.authLogin') }}" method="POST" autocomplete="off" novalidate="">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" class="form-control @error('senha') border-danger @enderror"
                                    placeholder="••••••••••" autocomplete="off" name="senha" required>
                                <span class="input-group-text @error('senha') border-danger @enderror">
                                    <a href="#" class="link-secondary" data-bs-toggle="tooltip"
                                        aria-label="Mostra senha"
                                        data-bs-original-title="Mostra senha"><!-- Download SVG icon from http://tabler.io/icons/icon/eye -->
