...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <a href="{{ route('investimentoCdb.extratoCompletoCdb', $investimento->id) }}"
        ...
        <div class="card-body">
            @foreach ($investimentoExtrato as $investimentoExtrato)
                ...
                <div>
                    ...
                    @php
                        $isEntrada = $investimentoExtrato->movimento === 'entrada' ? true : false;
                    ...
                    @foreach ($investimentoExtrato->investimentoExtratosDiarios as $extratoDiario)
                        <div @class([
                            'row',
                            'alert alert-success gap-0' => $isEntrada,
                            'alert alert-danger gap-0' => $isSaida,
                        ])>
