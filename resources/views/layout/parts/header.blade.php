            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm"
                        style="background-image: url(https://randomuser.me/api/portraits/men/9.jpg)"> </span>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('dashboard') }}">
                                    <x-icons.icon-home-outline />
                                    <span class="nav-link-title"> Home </span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('conta-bancaria.index') }}">
                                    <x-icons.icon-conta-outline />
                                    <span class="nav-link-title"> Contas </span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="">
                                    <x-icons.icon-cartao-outline />
                                    <span class="nav-link-title"> Cartões </span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('investimento.index') }}">
                                    <x-icons.icon-investimento-outline />
                                    <span class="nav-link-title"> Investimento </span>
                                </a>
                            </li>
                                        ...
                                        <div class="dropdown-menu-column">
                                            ...
                                            <div class="dropend">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="./sign-in-illustration.html" class="dropdown-item"> Sign
                                                        in with illustration </a>
